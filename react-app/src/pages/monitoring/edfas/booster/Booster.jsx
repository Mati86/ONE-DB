    ...
    <Layout requireDevice={true}>
      <Box sx={{ padding: 5 }}>
        <EdfaMonitoredData
          ...
          backReflectionPower={data?.data[EDFA_PARAMS.BackReflectionPower]}
          opticalReturnLoss={data?.data[EDFA_PARAMS.OpticalReturnLoss]}
          alsDisabledSecondsRemaining={
            data?.data[EDFA_PARAMS.AlsDisabledSecondsRemaining]
          }
