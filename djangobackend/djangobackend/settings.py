...
SECRET_KEY = 'django-insecure-s0qq4qzvp$93t2z_u1%=gffni(!8bz5mar0%$qaqz00c#4u9%+'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR.parent, "react-app/build")],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR.parent, 'react-app', 'build', 'static')
]
